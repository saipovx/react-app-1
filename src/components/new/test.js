  ...
  return (<>
    ...
    <header>
      <nav className={style.nav}>
        <Link to={'/'}>
          <img src="https://seller.ozon.ru/app/img/logo.072e375a.svg" className={style.nav__logo} alt="svg"/>
        </Link>
        {/* Link */}
        <div className={style.nav__admin}>
          <div className={style.nav__adminChel} id="myChel">
            test_api
            <svg className={style.nav__adminChelSvg} xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                 className="index_chevron_rV2nw">
          ...
          <Link to={'/'}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" data-onboarding-target="headerDialog"
                 className="index_iconButton_9ZdWq">
              <path fill="currentColor"
            ...
            <div className="akaunt1">
              <ul className="akaunt1__ul">
                <li>
                  ...
                  <Link to={'/'} className="akaunt1__ul-link">О курсах для продавцов</Link>
                </li>
                <li>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24">
                    <path fill="currentColor"
                  ...
                  <Link to={'/'} className="akaunt1__ul-link">Перейти к обучению</Link>
                </li>
              </ul>
            </div>
          </div>
      ...
      <nav className={style.navbar}>
        <ul className={style.navbar__ul}>
          <li><Link to={'/'} className={style.navbar__link}>Главная</Link></li>
          <li id="tovar">
            <Link to={'/'} className={style.navbar__link}>Товары и цены</Link>
            <div id="nav1" className="navbar__pos" style={{display:'none'}}>
              <div className="navbar__drow">
                <ul className="navbar__drow-ul">
                  <li><Link to={'/'} className="navbar__drow-ul-li">Список таваров</Link></li>
                  <li><Link to={'/'} className="navbar__drow-ul-link">таваров</Link></li>
                  <li><Link to={'/'} className="navbar__drow-ul-link">таваров</Link></li>
                  <li><Link to={'/'} className="navbar__drow-ul-link">таваров</Link></li>
                </ul>
                <ul className="navbar__drow-ul">
          ...
          <li id="tovar2">
            <Link to={'/'} className={style.navbar__link}>Финансы</Link>
          ...
          <li id="tovar3">
            <Link to={'/'} className={style.navbar__link}>Аналитика</Link>
            <div id="nav3" className="navbar__pos" style={{display:'none'}}>
              <div className="navbar__drow">
                <ul className="navbar__drow-ul">
                  <li><Link to={'/'} className="navbar__drow-ul-li">Список таваров</Link></li>
                  <li><Link to={'/'} className="navbar__drow-ul-link">таваров</Link></li>
          ...
          <li id="tovar4">
            <Link to={'/'} className={style.navbar__link}>Продвижение</Link>
          ...
          <li id="tovar5">
            <Link to={'/'} className={style.navbar__link}>Рейтинги</Link>
          ...
          <li id="tovar6">
            <Link to={'/'} className={style.navbar__link}>Отзывы</Link>
            <div id="nav6" className="navbar__pos" style={{display:'none'}}>
              <div className="navbar__drow">
                <ul className="navbar__drow-ul">
                  <li><Link to={'/'} className="navbar__drow-ul-link">таваров</Link></li>
                  <li><Link to={'/'} className="navbar__drow-ul-link">таваров</Link></li>
